...
namespace Ajsuth.Foundation.Catalog.Engine.Pipelines.Blocks
{
    ...
    /// <summary>
    /// The do action block that moves sellable item images down
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(Engine.CatalogConstants.Pipelines.Blocks.DoActionMoveDownSellableItemImage)]
    public class DoActionMoveDownSellableItemImageBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        /// <summary>
        ...
        /// <inheritdoc />
        /// <summary>Initializes a new instance of the <see cref="T:Ajsuth.Foundation.Catalog.Engine.Pipelines.Blocks.DoActionMoveDownSellableItemImageBlock" /> class.</summary>
        /// <param name="commander">The commerce commander.</param>
        public DoActionMoveDownSellableItemImageBlock(CommerceCommander commander)
          : base(null)
        {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            if (string.IsNullOrEmpty(entityView?.Action) ||
                    ...
                    !entityView.Action.Equals(context.GetPolicy<Policies.KnownCatalogActionsPolicy>().MoveDownSellableItemImage, StringComparison.OrdinalIgnoreCase)))
            {
                return entityView;
            }
            ...
            if (index < 0 || index >= imageComponent.Images.Count)
            {
                return entityView;
            }
